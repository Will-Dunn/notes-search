from notes_search.core.models import RelatedNoteAndChunk, SearchResult
...
class SearchService:
    ...
    def search(self, query: str, raw: bool = False, top_k: int = 10) -> SearchResult:
        ...
        note_results: list[RelatedNoteAndChunk] = []
        seen: set[str] = set()
        for chunk, score in chunk_results:
            ...
            if note is not None:
                note_results.append(RelatedNoteAndChunk(note=note, related_chunk=chunk, score=score))
